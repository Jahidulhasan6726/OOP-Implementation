    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                while (temp == 0)
                {
                    Console.Write("whice informaton do you want :\n[Hints]\n1.Car\n2.MotorCycle" +
                        "\nEnter serial No\t: ");
        ...
        private static void MotorCycleInfo()
        {
            ...
            motorCycle m = new motorCycle(maxPower,maximumTorque,startingMethod,mileage,cooling,frontBrake,
                rearBrake,modelNo,yearMake, noOfGear, engineCapacityinCC);
        ...
        private static void CarInfo()
        {
            ...
            car c = new car(numberOfSeats,numberOfDoor,stearingSystem,modelNo,yearMake,noOfGear,
                engineCapacityinCC);
            ...
            Console.WriteLine($"Enterior Design\t:{c.ShowSpecification()}");
